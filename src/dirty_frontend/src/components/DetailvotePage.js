        ...
        <section class="radio-section">
          <div class="radio-list">
            <div class="radio-item">
              ...
              <label for="radio1">VOTE 1</label>
            </div>
            <div class="radio-item">
              <input name="radio" id="radio2" type="radio" value="2">
              <label for="radio2">VOTE 2</label>
            </div>
            <div class="radio-item">
              <input name="radio" id="radio3" type="radio" value="3">
              <label for="radio3">VOTE 3</label>
            </div>
          </div>
        </section>
      </div>
      <div class="hmmbutton">
        <button type="button" id="viewhasil">View</button>
        <button type="button" id="confirm-vote">Confirm</button>
      </div>
    </div>
  `;
